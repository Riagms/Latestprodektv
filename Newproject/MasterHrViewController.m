...
-(void)jobsitepopover{
    ...
    UIView* popoverView = [[UIView alloc]
                           initWithFrame:CGRectMake(0, 0, 260, 200)];
    
    popoverView.backgroundColor = [UIColor whiteColor];
    _povertableview=[[UITableView alloc]initWithFrame:CGRectMake(0, 0, 260, 200)];
    ...
    popoverContent.contentSizeForViewInPopover = CGSizeMake(260, 200);
    ...
    self.povercontroller.popoverContentSize=CGSizeMake(260.0f, 200.0f);
    self.povercontroller=_povercontroller;
