...
-(void)DocumentSearch
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<DocumentSearch xmlns=\"http://ios.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://ios.kontract360.com/DocumentSearch" forHTTPHeaderField:@"Soapaction"];
...
- (IBAction)viewweb:(id)sender {
    ...
    [self UserLogmainview];
     NSString *fullURL =[NSString stringWithFormat:@"http://tools.prodektive.com%@",[_docdict objectForKey:[_documntarray objectAtIndex:textFieldIndexPath.row]]];
